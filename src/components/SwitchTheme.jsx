...
const SwitchTheme = () => {
    ...
    return (
        <div className="fixed z-50 top-2 left-2 p-2 cursor-pointer bg-gray-50 rounded bg-opacity-30 backdrop-filter backdrop-blur-md shadow-md dark:bg-gray-800 dark:bg-opacity-40">
